...
class UserFriendController extends AbstractController
{
    ...
    #[Route('/mon-profil/friends/add/{idUserReceive}/{idUserSender}', name: 'user_add_friend')]
    ...
    #[Route('/mon-profil/friends/delete/{idRelationShip}', name: 'user_delete_friend')]
    ...
    #[Route('/mon-profil/friends/accept/{idRelationShip}', name: 'user_accepte_friend')]
